...
function ChatHeader({ selectedLanguage }) {
  ...
  return (
    ...
    >
      <Typography variant="h4" className="chatHeaderText" sx={{ background: HEADER_TEXT_GRADIENT, textAlign: 'center', fontWeight: 'bold' }}>
        ⚙️ DevOps Career AI - Your Expert DevOps Guide
      </Typography>
    </Container>
  );
}
